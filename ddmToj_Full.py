...
modelName = 'Full_toj_vta'
data = hddm.load_csv(data_path)
data_folder = os.path.dirname(data_path)
models_dir = os.path.join(data_folder, 'Full_Models')
results_dir = os.path.join(data_folder, 'Full_Results')

os.makedirs(models_dir, exist_ok=True)
os.makedirs(results_dir, exist_ok=True)

reg_model = [
    "v ~ soa + C(hist, Treatment('R')) + C(hist, Treatment('R')):soa",
    "t ~ soa + C(hist, Treatment('R')) + C(hist, Treatment('R')):soa",
    "a ~ soa + C(hist, Treatment('R')) + C(hist, Treatment('R')):soa"
]
...
data_folder = os.path.dirname(data_path)
models_dir = os.path.join(data_folder, 'Full_Models')
plots_dir = os.path.join(data_folder, 'Full_Plots', modelName)
...
models_dir = os.path.join(data_folder, 'Full_Models')
results_dir = os.path.join(data_folder, 'Full_Results')
ppc_dir = os.path.join(data_folder, 'Full_PPC')
