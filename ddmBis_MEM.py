...
models_dir = os.path.join(data_folder, 'MEM_Models_z')
results_dir = os.path.join(data_folder, 'MEM_Results_z')
...
data_folder = os.path.dirname(data_path)
models_dir = os.path.join(data_folder, 'MEM_Models_z')
plots_dir = os.path.join(data_folder, 'MEM_Plots_z', modelName)
...
models_dir = os.path.join(data_folder, 'MEM_Models_z')
results_dir = os.path.join(data_folder, 'MEM_Results_z')
ppc_dir = os.path.join(data_folder, 'MEM_PPC_z')
