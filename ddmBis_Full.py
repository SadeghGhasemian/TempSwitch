...
# --- Config ---
data_path = r'E:\TemporalSwitch\HDDM _new\Drift_BIS\bisDDM.csv'
modelName = 'Full_bis_z'
data = hddm.load_csv(data_path)
data_folder = os.path.dirname(data_path)
models_dir = os.path.join(data_folder, 'Full_Models_z')
results_dir = os.path.join(data_folder, 'Full_Results_z')
...
data_folder = os.path.dirname(data_path)
models_dir = os.path.join(data_folder, 'Full_Models_z')
plots_dir = os.path.join(data_folder, 'Full_Plots_z', modelName)
...
models_dir = os.path.join(data_folder, 'Full_Models_z')
results_dir = os.path.join(data_folder, 'Full_Results_z')
ppc_dir = os.path.join(data_folder, 'Full_PPC_z')
