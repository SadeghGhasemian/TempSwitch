...
# Configuration
# ============================================
base_dir = r'E:\TemporalSwitch\HDDM_latest\power_analysis_bis_vt' # full model and different sample sizes
#base_dir = r'E:\TemporalSwitch\HDDM_latest\power_analysis_bis_vt\full_N35'
...
reg_model = [
    "a ~ 1",                                           
    "v ~ duration + C(hist, Treatment('R')) + C(hist, Treatment('R')):duration", # full model and different sample sizes                                           
    "t ~ duration + C(hist, Treatment('R')) + C(hist, Treatment('R')):duration", # full model and different sample sizes                                       
    "z ~ 1"   
]
